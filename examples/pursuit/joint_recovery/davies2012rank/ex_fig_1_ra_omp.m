% Studies the recovery probability of rank aware orthogonal matching
% pursuit with sparsity level and number of channels in joint recovery.
...
save ('bin/figure_1_ra_omp_success_with_K_S.mat');
