% Studies the recovery probability of rank aware order recursive
% matching pursuit with sparsity level and number of channels in joint recovery.
...
save ('bin/figure_1_ra_ormp_success_with_K_S.mat');
