...
fprintf('\nPoint density: %0.2f: , clustering error: %0.2f %% , clustering accuracy: %0.2f %%, mean spr error: %0.2f preserving : %0.2f %%, connectivity: %0.2f, elapsed time: %0.2f sec', rho, clustering_error_perc, clustering_acc_perc, spr_stats.spr_error, spr_stats.spr_perc, clustering_result.connectivity, elapsed_time);
fprintf('\n\n');
