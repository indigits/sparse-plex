classdef SPX_SignalsComparison < handle
    ...
    methods
        % Constructor
        function self = SPX_SignalsComparison(References, Estimates, K)
        ...
        function result = sparse_references(self)
            ...
            if isempty(self.SparseReferences)
                [self.SparseReferences, self.ReferenceLargestIndices] = SPX_SignalsComparison.sparse_approximation(self.References, self.K);
            end
        ...
        function sparse_estimates(self)
            ...
            if isempty(self.SparseEstimates)
                [self.SparseEstimates, self.EstimateLargestIndices] = SPX_SignalsComparison.sparse_approximation(self.Estimates, self.K);
            end
