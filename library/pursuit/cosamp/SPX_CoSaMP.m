classdef SPX_CoSaMP < handle
    ...
    methods
        function self  = SPX_CoSaMP(Dict, K)
        ...
        function result  = solve(self,y)
            ...
            while true
                ...
                if self.UseMPIdentification
                    largest2K  = SPX_CoSaMP.largest_mp(dict, r, extra);
                else
                    largest2K  = SPX_CoSaMP.largest_thresholding(dict, r, extra);
                end
